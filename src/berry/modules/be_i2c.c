...
#include "../../../libraries/berry/generate/be_fixed_be_class_i2c.h"

/* @const_object_info_begin

class be_class_i2c (scope: global, name: i2c, strings: weak) {
	.p, var
	init, func(m_initI2c)
	scan, func(m_scanI2c)
	start, func(m_startI2c)
	stop, func(m_stopI2c)
	readByte, func(m_readByteI2c)
	readBytes, func(m_readBytesI2c)
