...
ifeq ($(VERBOSE),YES)
    AR = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-ar
    ASM = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-gcc
    CC = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-gcc
    CPP = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-g++
    LINK = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-ld
    OBJCOPY = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-objcopy
    OBJDUMP = $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-objdump
else
    AR = @echo "AR $<" 2>/dev/null; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-ar
    ASM = @echo "ASM $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-gcc
    CC = @echo "CC  $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-gcc
    CPP = @echo "CPP $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-g++
    LINK = @echo "LINK $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-ld
    OBJCOPY = @echo "OBJCOPY $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-objcopy
    OBJDUMP = @echo "OBJDUMP $<"; $(TOOL_CHAIN_PATH)csky-elf-noneabiv2-objdump
endif
